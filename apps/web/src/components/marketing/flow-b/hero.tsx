			...
			<div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-[1.1fr_1fr] lg:items-center">
				<div>
					...
					<p className="mt-6 max-w-md text-lg text-steel">
						Wake up to rental opportunities you would have missed overnight. IntelliLease answers
						every call, figures out what the renter needs, and tells you exactly who to follow up
						with first.
					</p>
