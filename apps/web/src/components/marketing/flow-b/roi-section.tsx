...
import { submitMissedRevenueLead, type FlowBFormState } from '@/app/flow-b/actions';
	...
	return (
		<section className="border-t border-steel/20 bg-white px-6 py-24 sm:px-10 lg:px-16">
			<div className="mx-auto max-w-3xl text-center">
				...
				<div className="mx-auto mt-10 max-w-lg rounded-2xl border border-steel/20 bg-concrete/40 p-8 text-left">
				...
				<div className="mx-auto mt-8 max-w-lg rounded-2xl border border-steel/20 bg-white p-8 text-left">
					<p className="font-semibold text-ink">Want the full breakdown?</p>
					<p className="mt-1 text-sm text-steel">
						Leave your details and we&apos;ll follow up directly — no automated email, just a real
						conversation.
					</p>
					...
					{state.status === 'success' ? (
						...
						<form action={formAction} className="mt-6 space-y-4">
							...
							>
								{isPending ? 'Sending…' : 'Get the full breakdown'}
							</button>
						</form>
					)}
				</div>
