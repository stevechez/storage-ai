		...
		<section id="pricing" className="border-t border-steel/20 bg-concrete px-6 py-24 sm:px-10 lg:px-16">
			<div className="mx-auto max-w-4xl text-center">
				...
				<p className="mx-auto mt-4 max-w-2xl text-lg text-steel">
					...
					isn&apos;t &quot;try the software for a month&quot; — it&apos;s a chance to find out, with
					direct help from the person building it, whether IntelliLease actually captures rentals
					you&apos;d otherwise miss, without adding a single hire.
				</p>
				...
				<p className="mx-auto mt-10 max-w-xl text-sm text-steel">
					...
					designed to help operators capture opportunities they never knew they lost — without
					adding payroll.
				</p>
			</div>
		</section>
